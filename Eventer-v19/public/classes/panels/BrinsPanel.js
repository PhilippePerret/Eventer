class BrinsPanel extends Panel {
  ...
  constructor(event, db, options = {}) {
    super({
      ...
      modeName: options.filterMode ? 'filterBrins' : 'brins',
      editingModeName: 'brinEditing'
    })
  ...
  handleKeydown(e) {
    if (this.filterMode && e.key === 't' && !this.editing) {
      e.preventDefault()
      this.selectedBrins.clear()
      eventsPanel.showAllEvents()
      super.close()
      return true
    }
